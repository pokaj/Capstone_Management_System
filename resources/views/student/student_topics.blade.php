                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control search-input" name="project_title"   required>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea name="project_description" class="form-control search-input" rows="5" required></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
